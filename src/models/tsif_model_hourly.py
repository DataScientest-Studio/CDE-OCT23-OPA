...
def ts_into_features_hourly_LR(exchange):
    ...
    apple_experiment = mlflow.set_experiment("ts_into_features_Hourly_LR")
    #run_name = "second_run"
    artifact_path = "ts_into_features_Hourly_LR"
    ...
    with mlflow.start_run(run_name = f"ts_into_features_Hourly_LR_{exchange}") as run:
...
def main(exchanges):
    ...
    for exchange in exchanges:
        metrics_df = ts_into_features_hourly_LR(exchange)
        print(f"Run: ts_into_features Hourly - LR - {exchange}")
