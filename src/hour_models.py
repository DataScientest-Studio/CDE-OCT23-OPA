...
def hour_models(exchange):
    ...
    if not os.path.exists('dataviz/hour'):
        os.makedirs('dataviz/hour')
        
    plot_filename = f'dataviz/hour/{exchange}_{execution_date}.png'
...
def main(exchanges):
    ...
    for exchange in exchanges:
        metrics_df = hour_models(exchange)
